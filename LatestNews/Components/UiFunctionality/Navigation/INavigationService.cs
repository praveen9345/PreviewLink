namespace LatestNews.Components.UiFunctionality.Navigation
{
    ...
    public interface INavigationService
    {
        ...
        /// </summary>
        /// <typeparam name="T">The type of the data model used in the dialog. It must be a class that implements <see cref="INotifyPropertyChanged"/>.</typeparam>
        /// <returns>A <see cref="Task"/> that represents the asynchronous operation. The task result contains the result of the dialog.</returns>
        Task OpenPopUpDialogAndAwaitResultAsync<T>() where T : class, INotifyPropertyChanged;
    }
}